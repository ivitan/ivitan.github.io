...
for i in range(len(li)-1): # i表示第几趟
    ...
    if not exchange:
        return
```
![](/assets/Picture/images/maopao.gif)
...
```
![](/assets/Picture/images/xuanze.gif)
...
```
![](/assets/Picture/images/charu.gif
)
...
print(li)
```
![](/assets/Picture/images/kuaisu.gif)
...
def heap_sort(li):
   ...
   for i in range(n-1, -1, -1): #i表示当前的high值 也表示棋子的位置
       ...
       sift(li, 0, i-1)
```
![](/assets/Picture/images/zengdui.gif
)
...
merge_sort(li, 0, len(li)-1)
```
![](/assets/Picture/images/guibing.gif
)
